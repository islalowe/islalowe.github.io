...
An array `B[w]` is maintained to represent the maximum benefit achievable with total weight ≤ `w`.

We build this solution iteratively by considering items one at a time and updating the table.
